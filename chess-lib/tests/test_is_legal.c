...
int main(int argc, char const* argv[]) {
  ...
  test("8/8/7k/3Pp3/8/8/8/4K3 w - e5 0 2", move(d5, e6, ENPASSENT), 1);
  test("3r4/8/7k/3Pp3/8/8/8/3K4 w - e5 0 2", move(d5, e6, ENPASSENT), 0);
  test("3r2b1/8/7k/3Pp3/8/1K6/8/8 w - e5 0 2", move(d5, e6, ENPASSENT), 1);
  test("3r2b1/8/7k/1K1Pp2q/8/8/8/8 w - e5 0 2", move(d5, e6, ENPASSENT), 0);
  test("3r2b1/8/7k/2qPpK2/8/8/8/8 w - e5 0 2", move(d5, e6, ENPASSENT), 0);
  test("1b1r4/8/7k/3Pp3/8/6K1/8/8 w - e5 0 2", move(d5, e6, ENPASSENT), 0);
  test("b2r4/8/7k/3Pp3/8/8/6K1/8 w - e5 0 2", move(d5, e6, ENPASSENT), 0);
  test("b2r4/8/7k/3Pp3/6p1/8/6K1/8 w - e5 0 2", move(g2, g3, QUIET_MOVE), 1);
  test("b2r4/8/7k/3Pp3/6p1/8/6K1/8 w - e5 0 2", move(g2, h3, QUIET_MOVE), 0);
  test("b2r4/8/7k/3Pp3/6p1/8/6K1/8 w - e5 0 2", move(g2, f3, QUIET_MOVE), 0);
