...
int main(int argc, char const* argv[]) {
  ...
  test("K3r3/3P4/8/8/8/8/8/7k w - - 0 1", 10);
  test("4r3/3P4/8/8/8/8/4K3/7k w - - 0 1", 10);
  test("4r3/3P4/8/8/8/8/r7/1k1K4 w - - 0 1", 8);
  test("7k/8/8/1K1Pp2r/8/8/8/8 w - e6 0 1", 9);
  test("7k/8/8/1K1Pp3/7r/8/8/8 w - e6 0 1", 7);
  test("1K5k/8/8/3Pp3/5b1r/8/8/8 w - e6 0 1", 6);
  return 0;
}
